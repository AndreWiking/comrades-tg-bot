...
Мы подобрали вам возможных кандидатов, вот некоторые из них:
%s 
Если хотите еще предложений, переходите в наш телеграмм бот:
https://t.me/find_comrade_bot?start=%d`
